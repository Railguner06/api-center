...
public class DataOperationManage {
    ...
    public OperationResult<GatewayServerDetailVO> queryGatewayServerDetail(@RequestParam String groupId,
                                                                               @RequestParam String gatewayId,
                                                                               @RequestParam String page,
                                                                               @RequestParam String limit) {
        try {
            logger.info("查询网关服务详情数据开始 groupId：{} gatewayId：{} page：{} limit：{}", groupId, gatewayId, page, limit);
            OperationRequest<GatewayServerDetailVO> req = new OperationRequest<>(page, limit);
            req.setData(new GatewayServerDetailVO(groupId, gatewayId));
            OperationResult<GatewayServerDetailVO> operationResult = dataOperationManageService.queryGatewayServerDetail(req);
